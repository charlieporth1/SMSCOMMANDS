...
app.get('/IT-WAS-ME/WAS-ME-LOGIN-NO', (req, res) => {
    ...
    exec('. /usr/bin/cred.sh && sendemail -f $USER@otih-oith.us.to  -t $phonee  -m "Auth Code:  '+ authCode + ' " -s smtp.gmail.com:587 -o tls=yes -xu $usr -xp  $passwd ')
    ...
    wait(3000);
    if (authCode === createtextbox.innerText) {
            wait(1000);
            var exec = require('child-process-promise').exec;
